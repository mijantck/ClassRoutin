...
public class fragmeny_mon extends Fragment {

    String uid = FirebaseAuth.getInstance().getUid();
    private FirebaseFirestore db = FirebaseFirestore.getInstance();
    private CollectionReference notebookRef = db.collection("Users").document(uid).collection("Routin");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        routinView = inflater.inflate(R.layout.mon_activity,container,false);
        routinList  = (RecyclerView) routinView.findViewById(R.id.recycler_view_sun);
    ...
    public void onStart() {
        ...
        Query query = notebookRef.whereArrayContains("day","MonDay")
...
//                holder.serial.setText(model.getSerial());
              ...
              //  holder.day_view.setText("Monday");
            ...
            public RoutinViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.all_routin_new_layout_single,viewGroup,false);

                RoutinViewHolder viewHolderm = new RoutinViewHolder(view);
                return viewHolderm;
            }
        };
    ...
    private void cancel(long c) {
        ...
        Toast.makeText(getContext(), "Alarm is cancel "+request, Toast.LENGTH_SHORT).show();
