...
public class fragment_thu extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        routinView = inflater.inflate(R.layout.thu_activity,container,false);
    ...
    public void onStart() {
        ...
        Query query = notebookRef.whereArrayContains("day","ThursDay")
        ...
        FirestoreRecyclerAdapter<NoteRoutin,RoutinViewHolder> adapter
            ...
            protected void onBindViewHolder(@NonNull final RoutinViewHolder holder, final int position, @NonNull final NoteRoutin model) {
              ...
              //  holder.day_view.setText("Thursday");
