...
public class fragment_sun extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        routinView = inflater.inflate(R.layout.sun_activity, container, false);
    ...
    public void onStart() {
        ...
        Query query = (Query) notebookRef.whereArrayContains("day","SunDay")
                .orderBy("start_time", Query.Direction.ASCENDING);




        FirestoreRecyclerOptions options = new FirestoreRecyclerOptions.Builder<NoteRoutin>()
...
//                holder.serial.setText(model.getSerial());
              ...
              //  holder.day_view.setText("Sunday");
